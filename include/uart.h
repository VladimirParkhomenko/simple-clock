...
#define UART_IS_DATA          0              /**< receive data available      */
 ...
 *           - \b UART_IS_DATA successfully received data from UART
 *           - \b UART_NO_DATA
...
extern void uart_putx(uint8_t value);

extern void uart_putd(int value);
